...
const makeFive = () => {
	const num = 3;
	const power = 4;
	resultFive.innerHTML= num**power;
};
...
const makeEleven = () => {
	const num1 = 5;
	const num2 = 2;
	resultEleven.innerHTML = num1%num2;
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.innerHTML = str.substring(3);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.innerHTML = str.substring(3,7);
};
...
const makeEighteen = () => {
	...
	resultEighteen.innerHTML = str.replace(/world/gi, 'JavaScript')
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	resultNineteen.innerHTML= str.substr(7,6);
};
...
const makeTwentyOne = () => {
	resultTwentyOne.innerHTML = Math.random()*10;
};
...
const makeTwentySeven = () => {
	resultTwentySeven.innerHTML = Math.floor(Math.random()*50)+50;
};
